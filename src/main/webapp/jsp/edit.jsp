...
<form action="<c:url value='/edit?cid=${crms.cid}'/>" method="post">
<%--	<form action="edit?cid=${crms.cid}" method="post">--%>

	<table border="0" align="center" width="40%" style="margin-left: 100px;">
	<tr>
		<td width="100px">客户名称</td>
		<td width="40%">
			<input type="text" name="cname" value="${crms.cname}"/>
		</td>
		<td align="left">
	...
	<tr>
		<td>客户性别</td>
		<td>
			<input type="radio" name="gender" value="男" <c:if test = "${crms.gender eq '男'}"> checker='checked'</c:if>id="male"/>
			<label for="male">男</label>
			<input type="radio" name="gender" value="女" <c:if test = "${crms.gender eq '女'}"> checker='checked'</c:if>id="female"/>
	...
	<tr>
		<td>客户生日</td>
		<td>
			<input type="text" name="birthday" id="birthday" value="${crms.birthday}" readonly="readonly"/>
		</td>
		<td>
	...
	<tr>
		<td>手机</td>
		<td>
			<input type="text" name="cellphone" value="${crms.cellphone}"/>
		</td>
		<td>
	...
	<tr>
		<td>邮箱</td>
		<td>
			<input type="text" name="email" value="${crms.email}"/>
		</td>
		<td>
	...
	<tr>
		<td>描述</td>
		<td>
			<textarea rows="5" cols="30" name="description">${crms.description}</textarea>
		</td>
		<td>
